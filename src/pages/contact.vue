<template>
  <section id="contact">
    <div class="wrapper">
        <div class="container-fluid m-lg-5 mb-5 mt-5">
        ...
        <div class="row mb-5 mt-5 ">
          ...
          <div class="col-lg-5 text-left  ">
            ...
            <div class="row m-2 mt-3 mb-3">
              <div class="col-2">
                <a href="mailto:raengineers2444@gmail.com"><i class="far fa-envelope fa-lg"></i></a>
              </div>
              <div class="email col"><a href="mailto:raengineers2444@gmail.com">raengineers2444@gmail.com</a></div>
            </div>
            <div class="row m-2 mt-5">
              <div class="col-2">
                <i class="fas fa-phone-alt fa-lg"></i>
              </div>
              <div class="phone col">+91-8919107850</div>
            </div>
          </div>
          
          <div class="col-lg-5 text-left mt-5 mr-3 m-lg-1 align-middle">
...
#contact {
  ...
  width: 100%;
  height: 100vh;
  background: url("./../assets/network.jpg") top center;
